...
private:
	...
	// 4个根参数：2个CBV、1个SRV、1个描述符表（4个SRV）
...
void CameraAndDynamicIndexingApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L".\\main15\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L".\\main15\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");

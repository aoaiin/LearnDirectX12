...
private:
    ...
    void BuildDescriptorHeaps();	// 创建 描述符堆 ： 创建描述符堆的描述，创建堆
...
void BoxApp::Draw(const GameTimer& gt)
{
    ...
    mCommandList->SetGraphicsRootDescriptorTable(0, mCbvHeap->GetGPUDescriptorHandleForHeapStart()); // 设置 根描述符表 ：指定 绑定到渲染流水线的资源

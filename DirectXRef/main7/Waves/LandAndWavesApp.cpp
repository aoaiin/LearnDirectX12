...
void LandAndWavesApp::Draw(const GameTimer& gt)
{
	...
	// 
	// 根据 参数，重置命令列表时，使用不同的cmdlistAlloc、PSO
    if(mIsWireframe)
    {
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\color7.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\color7.hlsl", nullptr, "PS", "ps_5_0");

...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Default8.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Default8.hlsl", nullptr, "PS", "ps_5_0");

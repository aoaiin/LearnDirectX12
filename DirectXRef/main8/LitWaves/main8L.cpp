...
void LitWavesApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	// 8.1
	//float r = sinf(gt.TotalTime() * 4.0f) * 0.5f + 0.5f;
	//mMainPassCB.Lights[0].Strength = { r * 2.0f + 1.0f, 0.1f, 0.1f };	// 随时间变化 颜色的光
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\Default8L2.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\Default8L2.hlsl", nullptr, "PS", "ps_5_0");

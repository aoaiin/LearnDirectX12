...
{
	mShaders["tessVS"] = d3dUtil::CompileShader(L".\\main14\\BasicTessellation\\Shaders\\Tessellation.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["tessHS"] = d3dUtil::CompileShader(L".\\main14\\BasicTessellation\\Shaders\\Tessellation.hlsl", nullptr, "HS", "hs_5_0");
	mShaders["tessDS"] = d3dUtil::CompileShader(L".\\main14\\BasicTessellation\\Shaders\\Tessellation.hlsl", nullptr, "DS", "ds_5_0");
	mShaders["tessPS"] = d3dUtil::CompileShader(L".\\main14\\BasicTessellation\\Shaders\\Tessellation.hlsl", nullptr, "PS", "ps_5_0");
...
void BasicTessellationApp::BuildQuadPatchGeometry()
{
	...
	// 创建 gpu端的 VB、IB ：（利用上传堆）将数据 复制到默认堆
	...
	quadSubmesh.IndexCount = 4;		// 在 缓冲区中的 第几个
...
void BasicTessellationApp::BuildPSOs()
{
	...
	opaquePsoDesc.RasterizerState.FillMode = D3D12_FILL_MODE_WIREFRAME;		// 线框
